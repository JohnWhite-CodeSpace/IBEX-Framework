...
if __name__ == "__main__":
    ...
    # analyzer.init_analyzer_tensors('hi_hex_channel','lo_hex_channel', option="save_good_data_sums", no_data_option='all_channels_working')
    # analyzer_1 = ChannelAnalyzer("MainConfigAftersums_active_all.yml")
    # analyzer_1.init_analyzer_tensors('hi_hex_channel', 'lo_hex_channel', option="save_good_data_sums",
    #                                no_data_option='all_channels_working')
    # sleep(1)
    # del analyzer_1
    # sleep(10)
    analyzer_2 = ChannelAnalyzer("MainConfigBeforeaggregated_active_all.yml")
    analyzer_2.init_analyzer_tensors('hi_hex_channel', 'lo_hex_channel', option="aggregate_all_physical_features",
                                   no_data_option='all_channels_working')
    sleep(1)
    del analyzer_2
    sleep(10)
    analyzer_3 = ChannelAnalyzer("MainConfigAfteraggregated_active_all.yml")
    analyzer_3.init_analyzer_tensors('hi_hex_channel', 'lo_hex_channel', option="aggregate_all_physical_features",
                                   no_data_option='all_channels_working')
    sleep(1)
    del analyzer_3
    sleep(10)
